...
class GalleryImageController extends AbstractController
{
    ...
    {
        return $this->render('back/gallery_image/index.html.twig', ['gallery_images' => $galleryImageRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('back/gallery_image/new.html.twig', [
    ...
    {
        return $this->render('back/gallery_image/show.html.twig', ['gallery_image' => $galleryImage]);
    }
    ...
    public function edit(Request $request, GalleryImage $galleryImage): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('gallery_image_index', ['id' => $galleryImage->getId()]);
        }

        return $this->render('back/gallery_image/edit.html.twig', [
            'gallery_image' => $galleryImage,
            'form' => $form->createView(),
        ]);
    }
